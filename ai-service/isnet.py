"""
IS-Net (Intermediate Supervision Network) for Dichotomous Image Segmentation.
Architecture ported from: https://github.com/xuebinqin/DIS

This module provides the full ISNetDIS model for high-accuracy
background removal, optimized for product/jewelry photography.
"""
...
class RSU7(nn.Module):
    """RSU-7: depth=7 residual U-block."""
...
class RSU6(nn.Module):
    """RSU-6: depth=6 residual U-block."""
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
        super().__init__()
        self.rebnconvin = REBNCONV(in_ch, out_ch)
...
class RSU5(nn.Module):
    """RSU-5: depth=5 residual U-block."""
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
        super().__init__()
        self.rebnconvin = REBNCONV(in_ch, out_ch)
...
class RSU4(nn.Module):
    """RSU-4: depth=4 residual U-block."""
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
        super().__init__()
        self.rebnconvin = REBNCONV(in_ch, out_ch)
...
class RSU4F(nn.Module):
    """RSU-4F: depth=4 residual U-block with dilated convolutions (no pooling)."""
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
        super().__init__()
        self.rebnconvin = REBNCONV(in_ch, out_ch)
...
# =========================================
# IS-Net DIS (Dichotomous Image Segmentation)
# =========================================

class ISNetDIS(nn.Module):
    """
    IS-Net for Dichotomous Image Segmentation.
    This is the inference-only version (no GT encoder needed).
    """
